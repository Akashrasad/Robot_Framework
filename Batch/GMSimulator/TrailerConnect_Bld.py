...
def main():
  ...
  Trailer  = {'Type': 'Signal', 'Mode': 'HS', 'Name': 'VirtCtlAuxAlrmSnsCtlAval', 'Value': '0'}
           #  {'Type': 'Signal', 'Mode': 'HS', 'name': 'VirtCtlAuxAlrmSnsCtlAval', 'Value': '1'}
  payload_Tx.append(Trailer)
  #entry  = {'Type': 'Signal', 'Mode': 'HS', 'Name': 'TrlrConnCntr', 'Value': '1'}
  #payload_Tx.append(entry)
  #Trailer  = {'Type': 'Signal', 'Mode': 'HS', 'Name': 'TrlrConnStat', 'Value': '1'}
  #payload_Tx.append(Trailer)
