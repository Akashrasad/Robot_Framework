...
if vip_version.lower()=="ga":
    ...
    #data ='{"Type" : "RAW","Mode" : "HS","id" : "4D6","Value" : "0000000020000400"}'
    data ='{"Type" : "Signal","Mode" : "HS","name" : "RtLkFdbkCstAvlFlg1","Value" :"1"}'
    payload.append(data)
    data ='{"Type" : "Signal","Mode" : "HS","name" : "RtLkFdbkCstAvlFlg2","Value" :"1"}'
    payload.append(data)
    data ='{"Type" : "Signal","Mode" : "HS","name" : "RtLkFdbkCstAvlFlg3","Value" :"1"}'
    payload.append(data)
    data ='{"Type" : "Signal","Mode" : "HS","name" : "RtLkFdbkCstAvlFlg4","Value" :"1"}'
    payload.append(data)
    #data ='{"Type" : "RAW","Mode" : "HS","id" : "49B","Value" : "0000000001E00000"}'
    #payload.append(data)
