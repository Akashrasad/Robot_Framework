...
if vip_version.lower()=="ga":
    ...
    #data ='{"Type" : "Signal","Mode" : "HS","name" : "DrvrAlrtTypCstStAvl","Value" :"1"}'
    #payload.append(data)
    data ='{"Type" : "Signal","Mode" : "HS","name" : "DrvrAlrtTypCstAvlFlg1","Value" :"1"}'
    payload.append(data)
    data ='{"Type" : "Signal","Mode" : "HS","name" : "DrvrAlrtTypCstAvlFlg2","Value" :"1"}'
    payload.append(data)
    data ='{"Type" : "Signal","Mode" : "HS","name" : "DrvrAlrtTypCstAvlFlg3","Value" :"1"}'
    payload.append(data)
    data ='{"Type" : "Signal","Mode" : "HS","name" : "DrvrAlrtTypCstAvlFlg4","Value" :"1"}'
    payload.append(data)
    data ='{"Type" : "Signal","Mode" : "HS","name" : "DrvrAlrtTypCstAvlFlg5","Value" :"1"}'
    payload.append(data)
    data ='{"Type" : "Signal","Mode" : "HS","name" : "DrvrAlrtTypCstAvlFlg6","Value" :"1"}'
    payload.append(data)
    data ='{"Type" : "Signal","Mode" : "HS","name" : "DrvrAlrtTypCstAvlFlg7","Value" :"1"}'
    payload.append(data)
