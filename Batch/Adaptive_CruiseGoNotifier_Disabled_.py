...
if vip_version.lower()=="ga":
    data ='{"Type" : "Signal","Mode" : "HS","name" : "ODD_FUCID","Value" :"42"}'
    payload.append(data)
    data ='{"Type" : "Signal","Mode" : "HS","name" : "ODD_DataId","Value" :"13"}'
    payload.append(data)
    data ='{"Type" : "Signal","Mode" : "HS","name" : "ODD_DataVal","Value" :"0"}'
    payload.append(data)
    data ='{"Type" : "Signal","Mode" : "HS","name" : "ODD_DataType","Value" :"3"}'
    payload.append(data)
    data ='{"Type" : "Signal","Mode" : "HS","name" : "ODII_FUCID","Value" :"42"}'
    payload.append(data)
    data ='{"Type" : "Signal","Mode" : "HS","name" : "ODII_ODIInd13","Value" :"1"}'
    payload.append(data)
    ...
    payload.append(data)
    data ='{"Type" : "Signal","Mode" : "HS","name" : "RunBrdOpMdCstStAvail","Value" :"1"}'
    payload.append(data)'''
