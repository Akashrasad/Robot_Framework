...
enum class Screen : uint32_t
{
    ...
    ics_virtual_controls_bottom_status_bar = ramp::Hash(ics_virtual_controls_bottom_status_bar),
    ...
    ics_apa_bottom_status_bar = ramp::Hash(ics_apa_bottom_status_bar),
    ...
    ics_bottom_status_bar = ramp::Hash(ics_bottom_status_bar),
