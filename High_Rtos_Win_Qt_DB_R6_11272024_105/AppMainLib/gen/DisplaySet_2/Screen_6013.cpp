...
void Screen_6013::Widget_Logic_Visibility_virtualcontrols_1_0_4_wakeScreenExit_csm()
{
...
void Screen_6013::onScreenHide()
{
    ...
    Image_img_radio_button_on.State.unBind(gm::csm::VIRTUALCONTROLS_HILLDESCENT_STATUS_SIGNAL, mBindingsIds[4]);
}
...
void Screen_6013::onScreenShow()
{
    ...
    addDependency(this, &Screen_6013::Widget_Logic_Visibility_virtualcontrols_1_0_4_wakeScreenExit_csm, gm::csm::VIRTUALCONTROLS_ANDROID_NOIVI_STATE);
    ...
    mBindingsIds[4] = Image_img_radio_button_on.State.bind(gm::csm::VIRTUALCONTROLS_HILLDESCENT_STATUS_SIGNAL);
}
