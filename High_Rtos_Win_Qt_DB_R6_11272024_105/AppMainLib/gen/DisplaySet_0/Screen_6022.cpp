...
void Screen_6022::Widget_Logic_Visibility_virtualcontrols_1_4_0_6_fog_csm()
{
    ...
    Label_virtualcontrols_1_4_0_6_fog_csm.Visibility = var_013;
}
...
void Screen_6022::onScreenHide()
{
    ...
    Label_virtualcontrols_1_4_0_4_FogOff_csm.State.unBind(gm::csm::VIRTUALCONTROLS_SINGLEFOGLIGHT_STATE_INTERNAL, mBindingsIds[5]);
}
...
void Screen_6022::onScreenShow()
{
    ...
    addDependency(this, &Screen_6022::Widget_Logic_Visibility_virtualcontrols_1_0_4_wakeScreenExit_csm, gm::csm::VIRTUALCONTROLS_ANDROID_NOIVI_STATE);
    ...
    addDependency(this, &Screen_6022::Widget_Logic_Visibility_img_placeholder_WakeScreen, gm::csm::VIRTUALCONTROLS_ANDROID_NOIVI_STATE);
    mBindingsIds[4] = Image_img_placeholder_WakeScreen.State.bind(gm::csm::VIRTUALCONTROLS_WAKESCREEN_ANDROID_BUTTON_STATE);
    mBindingsIds[5] = Label_virtualcontrols_1_4_0_4_FogOff_csm.State.bind(gm::csm::VIRTUALCONTROLS_SINGLEFOGLIGHT_STATE_INTERNAL);
}
