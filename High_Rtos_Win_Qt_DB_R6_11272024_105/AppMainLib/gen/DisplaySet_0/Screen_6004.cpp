...
{
    const auto var_022 = gm::csm::VIRTUALCONTROLS_ANDROID_NOIVI_STATE.data();
    ...
    Image_img_settings_selector.Visibility = var_018;
}
...
void Screen_6004::onScreenShow()
{
    ...
    addDependency(this, &Screen_6004::Widget_Logic_Visibility_virtualcontrols_1_0_4_wakeScreenExit_csm, gm::csm::VIRTUALCONTROLS_ANDROID_NOIVI_STATE);
