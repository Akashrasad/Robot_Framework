...
Screen_6032::Screen_6032():BindableScreenLogic("6032")
{
}

void Screen_6032::Widget_Logic_Visibility_apa_3_0_Exit_f_csm()
{
...
{
    addDependency(this, &Screen_6032::Widget_Logic_Visibility_apa_3_0_Exit_f_csm, gm::csm::VIRTUALCONTROLS_ANDROID_LAUNCH_VISIBILITY);
    addDependency(this, &Screen_6032::Widget_Logic_Visibility_apa_3_0_Exit_f_csm, gm::csm::VIRTUALCONTROLS_ANDROID_NOIVI_STATE);
    ...
    addDependency(this, &Screen_6032::Widget_Logic_Visibility_img_placeholder_WakeScreen, gm::csm::VIRTUALCONTROLS_ANDROID_NOIVI_STATE);
