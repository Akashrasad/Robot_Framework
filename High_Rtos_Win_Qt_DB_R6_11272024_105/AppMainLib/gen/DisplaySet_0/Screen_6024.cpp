...
void Screen_6024::Widget_Logic_Visibility_img_controls_icn_fog_rear()
{
    ...
    Image_img_controls_icn_fog_rear.Visibility = var_001;
}
...
void Screen_6024::onScreenShow()
{
    ...
    addDependency(this, &Screen_6024::Widget_Logic_Visibility_virtualcontrols_1_0_4_wakeScreenExit_csm, gm::csm::VIRTUALCONTROLS_ANDROID_NOIVI_STATE);
    ...
    addDependency(this, &Screen_6024::Widget_Logic_Visibility_img_placeholder_WakeScreen, gm::csm::VIRTUALCONTROLS_ANDROID_NOIVI_STATE);
