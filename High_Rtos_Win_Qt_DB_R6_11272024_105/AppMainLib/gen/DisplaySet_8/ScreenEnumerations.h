...
enum class Screen : uint32_t
{
    ...
    ics_virtualcontrols_persistent_controls_speed_limiter_manual_active_snackbar = ramp::Hash(ics_virtualcontrols_persistent_controls_speed_limiter_manual_active_snackbar),
