...
void Screen_7002::onScreenHide()
{
    ...
    Image_img_park_right_perp.State.unBind(gm::csm::APA_PARK_INSTRUCTIONS_INTERNAL, mBindingsIds[8]);
}
...
void Screen_7002::onScreenShow()
{
    ...
    mBindingsIds[8] = Image_img_park_right_perp.State.bind(gm::csm::APA_PARK_INSTRUCTIONS_INTERNAL);
}
