...
#ifndef SCREEN_7040_H
#define SCREEN_7040_H
...
class Screen_7040 : public ::ramp::BindableScreenLogic
{
    public:
    Screen_7040(const std::string&  screen_id)  
    ...
    private:
    	...
    	widget_properties::LabelWidget Label_apa_5_1_maneuvermessaging5_1_csm{"apa_5_1_maneuvermessaging5_1_csm"};
