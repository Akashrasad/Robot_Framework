...
class Screen_6006 : public ::ramp::BindableScreenLogic
{
    public:
    Screen_6006(const std::string&  screen_id)  
    ...
    private:
    	...
    	widget_properties::ImageWidget Image_controls_icn_lockout_normal{"controls_icn_lockout_normal"};
    	...
    	widget_properties::LabelWidget Label_virtualcontrols_1_0_2_1_LockoutOn_csm{"virtualcontrols_1_0_2_1_LockoutOn_csm"};
    	widget_properties::LabelWidget Label_virtualcontrols_1_1_exitBtn_csm{"virtualcontrols_1_1_exitBtn_csm"};
    	widget_properties::LabelWidget Label_virtualcontrols_1_2_0_2WinLockTitle_csm{"virtualcontrols_1_2_0_2WinLockTitle_csm"};
    	widget_properties::LabelWidget Label_virtualcontrols_1_2_0_2_LockoutOff_csm{"virtualcontrols_1_2_0_2_LockoutOff_csm"};
    	widget_properties::LabelWidget Label_virtualcontrols_1_2_0_2_lockout_csm{"virtualcontrols_1_2_0_2_lockout_csm"};
    ...
    private:
    void Widget_Logic_Visibility_virtualcontrols_1_2_0_2_lockout_csm() noexcept;
    private:
    void Widget_Logic_Visibility_controls_icn_lockout_normal() noexcept;
    protected:
