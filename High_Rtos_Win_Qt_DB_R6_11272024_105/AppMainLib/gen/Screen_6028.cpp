...
void Screen_6028::Widget_Logic_Visibility_img_placeholder_WakeScreen() noexcept
{
...
void Screen_6028::Widget_Logic_Visibility_virtualcontrols_1_5_UGDO_csm() noexcept
{
    const bool var_004 = gm::csm::VIRTUALCONTROLS_CONTROL_PAGE_WHILE_DRIVING_INTERNAL.data();
    const bool var_003 = !(var_004);
    
    Label_virtualcontrols_1_5_UGDO_csm.mVisibility = var_003;
}

void Screen_6028::Widget_Logic_Visibility_virtualcontrols_1_0_4_wakeScreenExit_csm() noexcept
{
...
void Screen_6028::Widget_Logic_Visibility_img_close() noexcept
{
...
void Screen_6028::Widget_Logic_Visibility_grp_placeholder_WakeScreen() noexcept
{
...
void Screen_6028::onScreenHide()
{
    ...
    Label_virtualcontrols_1_5_F_UGDOTitle_csm.mState.unBind(gm::csm::Data_RHD_TITLE_ALIGNMENT_STATE, mBindingsIds[2U]);
    Image_img_pintostart.mVisibility.unBind(gm::csm::Data_PINTOSTART_VISIBILITY, mBindingsIds[3U]);
}
...
void Screen_6028::onScreenShow()
{
    ...
    addDependency(this, &Screen_6028::Widget_Logic_Visibility_virtualcontrols_1_5_UGDO_csm, gm::csm::VIRTUALCONTROLS_CONTROL_PAGE_WHILE_DRIVING_INTERNAL);
    ...
    mBindingsIds[2U] = Label_virtualcontrols_1_5_F_UGDOTitle_csm.mState.bind(gm::csm::Data_RHD_TITLE_ALIGNMENT_STATE);
    addDependency(this, &Screen_6028::Widget_Logic_Visibility_virtualcontrols_1_0_4_wakeScreenExit_csm, gm::csm::VIRTUALCONTROLS_ANDROID_LAUNCH_VISIBILITY);
    addDependency(this, &Screen_6028::Widget_Logic_Visibility_img_close, gm::csm::VIRTUALCONTROLS_ANDROID_LAUNCH_VISIBILITY,gm::csm::VIRTUALCONTROLS_ANDROID_NOIVI_STATE);
    mBindingsIds[3U] = Image_img_pintostart.mVisibility.bind(gm::csm::Data_PINTOSTART_VISIBILITY);
    addDependency(this, &Screen_6028::Widget_Logic_Visibility_grp_placeholder_WakeScreen, gm::csm::VIRTUALCONTROLS_ANDROID_LAUNCH_VISIBILITY);
}
