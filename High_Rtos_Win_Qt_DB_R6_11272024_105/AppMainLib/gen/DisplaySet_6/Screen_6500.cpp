...
void Screen_6500::onScreenHide()
{
    ...
    Image_img_card_controls_lights_placeholder.Visibility.unBind(gm::csm::VIRTUALCONTROLS_ANDROID_LAUNCH_VISIBILITY, mBindingsIds[4]);
}
...
void Screen_6500::onScreenShow()
{
    ...
    mBindingsIds[4] = Image_img_card_controls_lights_placeholder.Visibility.bind(gm::csm::VIRTUALCONTROLS_ANDROID_LAUNCH_VISIBILITY);
}
