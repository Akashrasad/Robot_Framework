...
static const size_t TotalScreens = 161;
...
constexpr static const char_t* const ics_virtual_controls_passive_power_mode_off_verify_snackbar = "ics_virtual_controls_passive_power_mode_off_verify_snackbar";
...
constexpr static const char_t* const ics_virtualcontrols_lane_keep_assist = "ics_virtualcontrols_lane_keep_assist";
...
constexpr static const char_t* const ics_virtualcontrols_outlets_start_screen = "ics_virtualcontrols_outlets_start_screen";
constexpr static const char_t* const ics_virtualcontrols_passive_power_mode_emergency_detected = "ics_virtualcontrols_passive_power_mode_emergency_detected";
constexpr static const char_t* const ics_virtualcontrols_passive_power_mode_extend_snackbar = "ics_virtualcontrols_passive_power_mode_extend_snackbar";
constexpr static const char_t* const ics_virtualcontrols_passive_power_mode_snackbar_remaining = "ics_virtualcontrols_passive_power_mode_snackbar_remaining";
constexpr static const char_t* const ics_virtualcontrols_peekin_screen_Time_running_out_notification = "ics_virtualcontrols_peekin_screen_Time_running_out_notification";
constexpr static const char_t* const ics_virtualcontrols_peekin_screen_end_notification = "ics_virtualcontrols_peekin_screen_end_notification";
...
constexpr static const char_t* const ics_virtualcontrols_range_reserve_tdl_set_to_100_confirm = "ics_virtualcontrols_range_reserve_tdl_set_to_100_confirm";
constexpr static const char_t* const ics_virtualcontrols_range_reserve_tdl_set_to_zero_confirm = "ics_virtualcontrols_range_reserve_tdl_set_to_zero_confirm";
constexpr static const char_t* const ics_virtualcontrols_range_reverse_reduce_propulsion = "ics_virtualcontrols_range_reverse_reduce_propulsion";
...
constexpr static const char_t* const ics_virtualcontrols_service_needed_fault = "ics_virtualcontrols_service_needed_fault";
constexpr static const char_t* const ics_virtualcontrols_start_screen_circut_breaker_fault = "ics_virtualcontrols_start_screen_circut_breaker_fault";
constexpr static const char_t* const ics_virtualcontrols_start_screen_customer_action_fault = "ics_virtualcontrols_start_screen_customer_action_fault";
constexpr static const char_t* const ics_virtualcontrols_start_screen_soc_low_fault = "ics_virtualcontrols_start_screen_soc_low_fault";
constexpr static const char_t* const ics_virtualcontrols_start_screen_tdl_set_thinking = "ics_virtualcontrols_start_screen_tdl_set_thinking";
constexpr static const char_t* const ics_virtualcontrols_start_screen_tdl_set_thinking_snackbar = "ics_virtualcontrols_start_screen_tdl_set_thinking_snackbar";
constexpr static const char_t* const ics_virtualcontrols_start_screen_vehicle_conditions_not_met_fault = "ics_virtualcontrols_start_screen_vehicle_conditions_not_met_fault";
constexpr static const char_t* const ics_virtualcontrols_summary_screen = "ics_virtualcontrols_summary_screen";
