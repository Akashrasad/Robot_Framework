...
void Screen_7038::onScreenHide()
{
    Image_img_park_left_parallel.mState.unBind(gm::csm::Data_APA_LEFT_PARK_INSTRUCTION, mBindingsIds[0U]);
    Image_img_park_right_parallel.mState.unBind(gm::csm::Data_APA_RIGHT_PARK_INSTRUCTION, mBindingsIds[1U]);
    ...
    Image_img_park_left_perp.mState.unBind(gm::csm::Data_APA_LEFT_PARK_INSTRUCTION, mBindingsIds[4U]);
    Image_img_park_right_perp.mState.unBind(gm::csm::Data_APA_RIGHT_PARK_INSTRUCTION, mBindingsIds[5U]);
    Group_grp_exit_apa_btn.mVisibility.unBind(gm::csm::EXIT_BUTTON_AVAILABLE_IN_APA, mBindingsIds[6U]);
}

void Screen_7038::onScreenShow()
{
    mBindingsIds[0U] = Image_img_park_left_parallel.mState.bind(gm::csm::Data_APA_LEFT_PARK_INSTRUCTION);
    mBindingsIds[1U] = Image_img_park_right_parallel.mState.bind(gm::csm::Data_APA_RIGHT_PARK_INSTRUCTION);
    ...
    mBindingsIds[4U] = Image_img_park_left_perp.mState.bind(gm::csm::Data_APA_LEFT_PARK_INSTRUCTION);
    mBindingsIds[5U] = Image_img_park_right_perp.mState.bind(gm::csm::Data_APA_RIGHT_PARK_INSTRUCTION);
