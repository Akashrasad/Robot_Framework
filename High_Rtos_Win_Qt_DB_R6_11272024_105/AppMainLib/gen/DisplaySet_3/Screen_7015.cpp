...
void Screen_7015::onScreenHide()
{
    ...
    Label_apa_5_1_maneuvermessaging1_csm.State.unBind(gm::csm::Data_Apa_Camera_Internal, mBindingsIds[9]);
}
...
void Screen_7015::onScreenShow()
{
    ...
    mBindingsIds[9] = Label_apa_5_1_maneuvermessaging1_csm.State.bind(gm::csm::Data_Apa_Camera_Internal);
}
