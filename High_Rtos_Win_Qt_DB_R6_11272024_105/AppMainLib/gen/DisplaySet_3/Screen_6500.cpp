...
void Screen_6500::Widget_Logic_Visibility_img_card_controls_settings_placeholder()
{
    ...
    const auto var_027 = gm::csm::VIRTUALCONTROLS_ANDROID_LAUNCH_VISIBILITY.data();
...
void Screen_6500::Widget_Logic_Visibility_img_card_controls_vehiclesettings_placeholder()
{
    ...
    const auto var_035 = gm::csm::VIRTUALCONTROLS_ANDROID_LAUNCH_VISIBILITY.data();
...
{
    const auto var_039 = gm::csm::VIRTUALCONTROLS_ANDROID_LAUNCH_VISIBILITY.data();
...
void Screen_6500::Widget_Logic_Visibility_img_card_controls_remotes_placeholder()
{
    ...
    const auto var_044 = gm::csm::VIRTUALCONTROLS_ANDROID_LAUNCH_VISIBILITY.data();
...
void Screen_6500::Widget_Logic_Visibility_virtualcontrols_1_0_ugdo_csm()
{
    ...
    const auto var_047 = gm::csm::VIRTUALCONTROLS_ANDROID_LAUNCH_VISIBILITY.data();
...
{
    const auto var_052 = gm::csm::VIRTUALCONTROLS_ANDROID_LAUNCH_VISIBILITY.data();
...
void Screen_6500::Widget_Logic_Visibility_virtualcontrols_1_0_settings_csm()
{
    ...
    const auto var_060 = gm::csm::VIRTUALCONTROLS_ANDROID_LAUNCH_VISIBILITY.data();
...
{
    Image_img_card_controls_park_placeholder.Visibility.unBind(gm::csm::VIRTUALCONTROLS_ANDROID_LAUNCH_VISIBILITY, mBindingsIds[0]);
    Label_virtualcontrols_1_0_LightsCard_csm.Visibility.unBind(gm::csm::VIRTUALCONTROLS_ANDROID_LAUNCH_VISIBILITY, mBindingsIds[1]);
    Label_virtualcontrols_1_0_park_csm.Visibility.unBind(gm::csm::VIRTUALCONTROLS_ANDROID_LAUNCH_VISIBILITY, mBindingsIds[2]);
    Image_img_card_controls_drivepark_placeholder.Visibility.unBind(gm::csm::VIRTUALCONTROLS_ANDROID_LAUNCH_VISIBILITY, mBindingsIds[3]);
    Image_img_card_controls_remotes_placeholder.State.unBind(VIRTUALCONTROLS_DRIVING_SPEED_INTERNAL, mBindingsIds[4]);
    Label_virtualcontrols_1_0_drive_csm.Visibility.unBind(gm::csm::VIRTUALCONTROLS_ANDROID_LAUNCH_VISIBILITY, mBindingsIds[5]);
    Image_img_card_controls_remotes.State.unBind(VIRTUALCONTROLS_DRIVING_SPEED_INTERNAL, mBindingsIds[6]);
    Label_virtualcontrols_1_0_DriveParkCard_csm.Visibility.unBind(gm::csm::VIRTUALCONTROLS_ANDROID_LAUNCH_VISIBILITY, mBindingsIds[7]);
    Image_img_card_controls_lights_placeholder.Visibility.unBind(gm::csm::VIRTUALCONTROLS_ANDROID_LAUNCH_VISIBILITY, mBindingsIds[8]);
}
...
void Screen_6500::onScreenShow()
{
    ...
    addDependency(this, &Screen_6500::Widget_Logic_Visibility_img_card_controls_drive_placeholder, gm::csm::VIRTUALCONTROLS_ANDROID_LAUNCH_VISIBILITY);
    ...
    mBindingsIds[0] = Image_img_card_controls_park_placeholder.Visibility.bind(gm::csm::VIRTUALCONTROLS_ANDROID_LAUNCH_VISIBILITY);
    mBindingsIds[1] = Label_virtualcontrols_1_0_LightsCard_csm.Visibility.bind(gm::csm::VIRTUALCONTROLS_ANDROID_LAUNCH_VISIBILITY);
    ...
    addDependency(this, &Screen_6500::Widget_Logic_Visibility_apa_3_0_Park_f_csm, gm::csm::VIRTUALCONTROLS_ANDROID_LAUNCH_VISIBILITY);
    ...
    mBindingsIds[2] = Label_virtualcontrols_1_0_park_csm.Visibility.bind(gm::csm::VIRTUALCONTROLS_ANDROID_LAUNCH_VISIBILITY);
    mBindingsIds[3] = Image_img_card_controls_drivepark_placeholder.Visibility.bind(gm::csm::VIRTUALCONTROLS_ANDROID_LAUNCH_VISIBILITY);
    ...
    mBindingsIds[5] = Label_virtualcontrols_1_0_drive_csm.Visibility.bind(gm::csm::VIRTUALCONTROLS_ANDROID_LAUNCH_VISIBILITY);
    ...
    mBindingsIds[7] = Label_virtualcontrols_1_0_DriveParkCard_csm.Visibility.bind(gm::csm::VIRTUALCONTROLS_ANDROID_LAUNCH_VISIBILITY);
    ...
    mBindingsIds[8] = Image_img_card_controls_lights_placeholder.Visibility.bind(gm::csm::VIRTUALCONTROLS_ANDROID_LAUNCH_VISIBILITY);
}
