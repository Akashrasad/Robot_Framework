...
void Screen_6028::Widget_Logic_Visibility_grp_img_close()
{
...
void Screen_6028::Widget_Logic_Visibility_virtualcontrols_1_1_exitBtn_csm()
{
    ...
    GroupLabel_virtualcontrols_1_1_exitBtn_csm.Visibility = var_013;
}

void Screen_6028::Widget_Logic_Visibility_virtualcontrols_1_0_4_wakeScreenExit_csm()
{
    const auto var_019 = gm::csm::VIRTUALCONTROLS_ANDROID_LAUNCH_VISIBILITY.data();
    const auto var_018 = !(var_019);
    
    Label_virtualcontrols_1_0_4_wakeScreenExit_csm.Visibility = var_018;
}
...
void Screen_6028::onScreenHide()
{
    ...
    Image_img_pintostart.Visibility.unBind(gm::csm::Data_PINTOSTART_VISIBILITY, mBindingsIds[1]);
}

void Screen_6028::onScreenShow()
{
    addDependency(this, &Screen_6028::Widget_Logic_Visibility_grp_img_close, gm::csm::VIRTUALCONTROLS_ANDROID_LAUNCH_VISIBILITY);
    addDependency(this, &Screen_6028::Widget_Logic_Visibility_grp_img_close, gm::csm::VIRTUALCONTROLS_ANDROID_NOIVI_STATE);
    ...
    addDependency(this, &Screen_6028::Widget_Logic_Visibility_virtualcontrols_1_1_exitBtn_csm, gm::csm::VIRTUALCONTROLS_ANDROID_LAUNCH_VISIBILITY);
    addDependency(this, &Screen_6028::Widget_Logic_Visibility_virtualcontrols_1_1_exitBtn_csm, gm::csm::VIRTUALCONTROLS_ANDROID_NOIVI_STATE);
    mBindingsIds[1] = Image_img_pintostart.Visibility.bind(gm::csm::Data_PINTOSTART_VISIBILITY);
