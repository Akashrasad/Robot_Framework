...
void Screen_6004::Widget_Logic_Visibility_img_settings_selector()
{
    ...
    Image_img_settings_selector.Visibility = var_001;
}
...
void Screen_6004::Widget_Logic_Visibility_virtualcontrols_1_1_exitBtn_csm()
{
    ...
    GroupLabel_virtualcontrols_1_1_exitBtn_csm.Visibility = var_008;
}

void Screen_6004::Widget_Logic_Visibility_grp_img_close()
{
    ...
    Group_grp_img_close.Visibility = var_013;
}

void Screen_6004::Widget_Logic_Visibility_virtualcontrols_1_0_4_wakeScreenExit_csm()
{
...
void Screen_6004::onScreenShow()
{
    ...
    addDependency(this, &Screen_6004::Widget_Logic_Visibility_grp_img_close, gm::csm::VIRTUALCONTROLS_ANDROID_LAUNCH_VISIBILITY);
    addDependency(this, &Screen_6004::Widget_Logic_Visibility_grp_img_close, gm::csm::VIRTUALCONTROLS_ANDROID_NOIVI_STATE);
    addDependency(this, &Screen_6004::Widget_Logic_Visibility_virtualcontrols_1_0_4_wakeScreenExit_csm, gm::csm::VIRTUALCONTROLS_ANDROID_LAUNCH_VISIBILITY);
