...
class Screen_8015 : public ::ramp::BindableScreenLogic
{
    public:
    Screen_8015(const std::string&  screen_id)  
    ...
    private:
    	...
    	widget_properties::LabelWidget Label_safetysystems_2_1_1_Rear_f_csm{"safetysystems_2_1_1_Rear_f_csm"};
