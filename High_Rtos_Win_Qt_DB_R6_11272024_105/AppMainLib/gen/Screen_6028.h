...
class Screen_6028 : public ::ramp::BindableScreenLogic
{
    public:
    Screen_6028(const std::string&  screen_id)  
    ...
    private:
    	...
    	widget_properties::LabelWidget Label_virtualcontrols_1_5_F_UGDOTitle_csm{"virtualcontrols_1_5_F_UGDOTitle_csm"};
    ...
    private:
    void Widget_Logic_Visibility_virtualcontrols_1_5_UGDO_csm() noexcept;
    private:
