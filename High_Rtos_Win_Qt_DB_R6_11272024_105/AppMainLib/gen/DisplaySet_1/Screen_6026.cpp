...
void Screen_6026::Widget_Logic_Visibility_virtualcontrols_1_0_4_wakeScreenExit_csm()
{
...
void Screen_6026::Widget_Logic_Visibility_virtualcontrols_1_4_0_8_cargo_csm()
{
    ...
    Label_virtualcontrols_1_4_0_8_cargo_csm.Visibility = var_008;
}
...
void Screen_6026::Widget_Logic_Visibility_grp_img_close()
{
    ...
    Group_grp_img_close.Visibility = var_012;
}

void Screen_6026::Widget_Logic_Visibility_virtualcontrols_1_1_exitBtn_csm()
{
    ...
    GroupLabel_virtualcontrols_1_1_exitBtn_csm.Visibility = var_017;
}
...
void Screen_6026::Widget_Logic_Visibility_img_control_beams()
{
    ...
    Image_img_control_beams.Visibility = var_022;
}
...
void Screen_6026::onScreenShow()
{
    ...
    addDependency(this, &Screen_6026::Widget_Logic_Visibility_grp_img_close, gm::csm::VIRTUALCONTROLS_ANDROID_LAUNCH_VISIBILITY);
    addDependency(this, &Screen_6026::Widget_Logic_Visibility_grp_img_close, gm::csm::VIRTUALCONTROLS_ANDROID_NOIVI_STATE);
    addDependency(this, &Screen_6026::Widget_Logic_Visibility_virtualcontrols_1_1_exitBtn_csm, gm::csm::VIRTUALCONTROLS_ANDROID_LAUNCH_VISIBILITY);
    addDependency(this, &Screen_6026::Widget_Logic_Visibility_virtualcontrols_1_1_exitBtn_csm, gm::csm::VIRTUALCONTROLS_ANDROID_NOIVI_STATE);
