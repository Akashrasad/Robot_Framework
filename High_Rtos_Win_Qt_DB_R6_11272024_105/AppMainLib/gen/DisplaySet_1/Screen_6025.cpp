...
void Screen_6025::Widget_Logic_Visibility_virtualcontrols_1_4_0_7_fog_front_rear_csm()
{
    ...
    Label_virtualcontrols_1_4_0_7_fog_front_rear_csm.Visibility = var_001;
}
...
void Screen_6025::Widget_Logic_Visibility_grp_img_close()
{
    ...
    Group_grp_img_close.Visibility = var_008;
}
...
void Screen_6025::Widget_Logic_Visibility_img_controls_icn_fog_front()
{
    ...
    Image_img_controls_icn_fog_front.Visibility = var_013;
}
...
void Screen_6025::Widget_Logic_Visibility_virtualcontrols_1_0_4_wakeScreenExit_csm()
{
...
void Screen_6025::onScreenHide()
{
    ...
    Image_img_radio_button_Rear_On.State.unBind(gm::csm::VIRTUALCONTROLS_DUALFOGLIGHT_STATE_INTERNAL, mBindingsIds[1]);
    Label_virtualcontrols_1_4_0_7_fog_front_rear_both_on_csm.State.unBind(gm::csm::VIRTUALCONTROLS_DUALFOGLIGHT_STATE_INTERNAL, mBindingsIds[2]);
    Image_img_radio_button_Both_Off.State.unBind(gm::csm::VIRTUALCONTROLS_DUALFOGLIGHT_STATE_INTERNAL, mBindingsIds[3]);
    Label_virtualcontrols_1_4_0_7_fog_front_rear_front_on_csm.State.unBind(gm::csm::VIRTUALCONTROLS_DUALFOGLIGHT_STATE_INTERNAL, mBindingsIds[4]);
    Label_virtualcontrols_1_4_0_7_fog_front_rear_rear_on_csm.State.unBind(gm::csm::VIRTUALCONTROLS_DUALFOGLIGHT_STATE_INTERNAL, mBindingsIds[5]);
    Image_img_radio_button_Front_On.State.unBind(gm::csm::VIRTUALCONTROLS_DUALFOGLIGHT_STATE_INTERNAL, mBindingsIds[6]);
    Label_virtualcontrols_1_4_0_7_fog_front_rear_both_off_csm.State.unBind(gm::csm::VIRTUALCONTROLS_DUALFOGLIGHT_STATE_INTERNAL, mBindingsIds[7]);
    Image_img_radio_button_Both_On.State.unBind(gm::csm::VIRTUALCONTROLS_DUALFOGLIGHT_STATE_INTERNAL, mBindingsIds[8]);
...
void Screen_6025::onScreenShow()
{
    ...
    mBindingsIds[1] = Image_img_radio_button_Rear_On.State.bind(gm::csm::VIRTUALCONTROLS_DUALFOGLIGHT_STATE_INTERNAL);
    ...
    addDependency(this, &Screen_6025::Widget_Logic_Visibility_grp_img_close, gm::csm::VIRTUALCONTROLS_ANDROID_LAUNCH_VISIBILITY);
    addDependency(this, &Screen_6025::Widget_Logic_Visibility_grp_img_close, gm::csm::VIRTUALCONTROLS_ANDROID_NOIVI_STATE);
    ...
    mBindingsIds[2] = Label_virtualcontrols_1_4_0_7_fog_front_rear_both_on_csm.State.bind(gm::csm::VIRTUALCONTROLS_DUALFOGLIGHT_STATE_INTERNAL);
    mBindingsIds[3] = Image_img_radio_button_Both_Off.State.bind(gm::csm::VIRTUALCONTROLS_DUALFOGLIGHT_STATE_INTERNAL);
    mBindingsIds[4] = Label_virtualcontrols_1_4_0_7_fog_front_rear_front_on_csm.State.bind(gm::csm::VIRTUALCONTROLS_DUALFOGLIGHT_STATE_INTERNAL);
    ...
    mBindingsIds[5] = Label_virtualcontrols_1_4_0_7_fog_front_rear_rear_on_csm.State.bind(gm::csm::VIRTUALCONTROLS_DUALFOGLIGHT_STATE_INTERNAL);
    mBindingsIds[6] = Image_img_radio_button_Front_On.State.bind(gm::csm::VIRTUALCONTROLS_DUALFOGLIGHT_STATE_INTERNAL);
    mBindingsIds[7] = Label_virtualcontrols_1_4_0_7_fog_front_rear_both_off_csm.State.bind(gm::csm::VIRTUALCONTROLS_DUALFOGLIGHT_STATE_INTERNAL);
    mBindingsIds[8] = Image_img_radio_button_Both_On.State.bind(gm::csm::VIRTUALCONTROLS_DUALFOGLIGHT_STATE_INTERNAL);
