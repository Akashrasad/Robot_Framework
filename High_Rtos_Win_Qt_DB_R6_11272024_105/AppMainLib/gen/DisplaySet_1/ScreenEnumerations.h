...
enum class Screen : uint32_t
{
    ...
    ics_virtualcontrols_pin_to_start_too_many_tries = ramp::Hash(ics_virtualcontrols_pin_to_start_too_many_tries),
    ...
    ics_virtualcontrols_pin_to_start_incorrect_entry = ramp::Hash(ics_virtualcontrols_pin_to_start_incorrect_entry),
    ics_virtualcontrols_fog_lights_unavailable_snackbar = ramp::Hash(ics_virtualcontrols_fog_lights_unavailable_snackbar),
    ics_virtualcontrols_pin_to_start_timer_expired = ramp::Hash(ics_virtualcontrols_pin_to_start_timer_expired),
