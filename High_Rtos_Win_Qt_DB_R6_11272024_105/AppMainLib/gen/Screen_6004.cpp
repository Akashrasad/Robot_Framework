...
void Screen_6004::Widget_Logic_Visibility_img_close() noexcept
{
...
void Screen_6004::Widget_Logic_Visibility_virtualcontrols_1_1_exitBtn_csm() noexcept
{
...
void Screen_6004::Widget_Logic_Visibility_grp_placeholder_WakeScreen() noexcept
{
...
void Screen_6004::onScreenHide()
{
    ...
    Label_virtualcontrols_1_0_4_1_DoorWindowTitle_csm.mState.unBind(gm::csm::Data_RHD_TITLE_ALIGNMENT_STATE, mBindingsIds[2U]);
}

void Screen_6004::onScreenShow()
{
    addDependency(this, &Screen_6004::Widget_Logic_Visibility_img_close, gm::csm::VIRTUALCONTROLS_ANDROID_LAUNCH_VISIBILITY,gm::csm::VIRTUALCONTROLS_ANDROID_NOIVI_STATE);
    mBindingsIds[0U] = Image_img_pintostart.mVisibility.bind(gm::csm::Data_PINTOSTART_VISIBILITY);
    addDependency(this, &Screen_6004::Widget_Logic_Visibility_virtualcontrols_1_1_exitBtn_csm, gm::csm::VIRTUALCONTROLS_ANDROID_LAUNCH_VISIBILITY,gm::csm::VIRTUALCONTROLS_ANDROID_NOIVI_STATE);
    addDependency(this, &Screen_6004::Widget_Logic_Visibility_grp_placeholder_WakeScreen, gm::csm::VIRTUALCONTROLS_ANDROID_LAUNCH_VISIBILITY);
    mBindingsIds[1U] = GroupImage_img_placeholder_WakeScreen.mState.bind(gm::csm::VIRTUALCONTROLS_WAKESCREEN_ANDROID_BUTTON_STATE);
    mBindingsIds[2U] = Label_virtualcontrols_1_0_4_1_DoorWindowTitle_csm.mState.bind(gm::csm::Data_RHD_TITLE_ALIGNMENT_STATE);
}
