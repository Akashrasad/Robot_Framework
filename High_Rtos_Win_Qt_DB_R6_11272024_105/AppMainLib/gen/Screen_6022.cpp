...
void Screen_6022::Widget_Logic_Visibility_img_close() noexcept
{
...
void Screen_6022::Widget_Logic_Visibility_grp_placeholder_WakeScreen() noexcept
{
...
void Screen_6022::Widget_Logic_Visibility_img_placeholder_WakeScreen() noexcept
{
...
void Screen_6022::Widget_Logic_Visibility_virtualcontrols_1_0_4_wakeScreenExit_csm() noexcept
{
...
void Screen_6022::Widget_Logic_Visibility_virtualcontrols_1_4_0_6_fog_csm() noexcept
{
    const bool var_013 = gm::csm::VIRTUALCONTROLS_CONTROL_PAGE_WHILE_DRIVING_INTERNAL.data();
    const bool var_012 = !(var_013);
    
    Label_virtualcontrols_1_4_0_6_fog_csm.mVisibility = var_012;
}

void Screen_6022::Widget_Logic_Visibility_img_controls_icn_fog_front() noexcept
{
    const bool var_015 = gm::csm::VIRTUALCONTROLS_CONTROL_PAGE_WHILE_DRIVING_INTERNAL.data();
    const bool var_014 = !(var_015);
    
    Image_img_controls_icn_fog_front.mVisibility = var_014;
}

void Screen_6022::onScreenHide()
{
    Image_img_radio_button_Off.mState.unBind(gm::csm::VIRTUALCONTROLS_SINGLEFOGLIGHT_STATE_INTERNAL, mBindingsIds[0U]);
    Label_virtualcontrols_1_4_0_4_FogOn_csm.mState.unBind(gm::csm::VIRTUALCONTROLS_SINGLEFOGLIGHT_STATE_INTERNAL, mBindingsIds[1U]);
    ...
    Image_img_radio_button_on.mState.unBind(gm::csm::VIRTUALCONTROLS_SINGLEFOGLIGHT_STATE_INTERNAL, mBindingsIds[3U]);
    Label_virtualcontrols_1_4_0_4_FogOff_csm.mState.unBind(gm::csm::VIRTUALCONTROLS_SINGLEFOGLIGHT_STATE_INTERNAL, mBindingsIds[4U]);
    Label_virtualcontrols_1_4_fog_csm.mState.unBind(gm::csm::Data_RHD_TITLE_ALIGNMENT_STATE, mBindingsIds[5U]);
...
{
    mBindingsIds[0U] = Image_img_radio_button_Off.mState.bind(gm::csm::VIRTUALCONTROLS_SINGLEFOGLIGHT_STATE_INTERNAL);
    addDependency(this, &Screen_6022::Widget_Logic_Visibility_img_close, gm::csm::VIRTUALCONTROLS_ANDROID_LAUNCH_VISIBILITY,gm::csm::VIRTUALCONTROLS_ANDROID_NOIVI_STATE);
    mBindingsIds[1U] = Label_virtualcontrols_1_4_0_4_FogOn_csm.mState.bind(gm::csm::VIRTUALCONTROLS_SINGLEFOGLIGHT_STATE_INTERNAL);
    addDependency(this, &Screen_6022::Widget_Logic_Visibility_grp_placeholder_WakeScreen, gm::csm::VIRTUALCONTROLS_ANDROID_LAUNCH_VISIBILITY);
    ...
    mBindingsIds[3U] = Image_img_radio_button_on.mState.bind(gm::csm::VIRTUALCONTROLS_SINGLEFOGLIGHT_STATE_INTERNAL);
    mBindingsIds[4U] = Label_virtualcontrols_1_4_0_4_FogOff_csm.mState.bind(gm::csm::VIRTUALCONTROLS_SINGLEFOGLIGHT_STATE_INTERNAL);
    mBindingsIds[5U] = Label_virtualcontrols_1_4_fog_csm.mState.bind(gm::csm::Data_RHD_TITLE_ALIGNMENT_STATE);
