...
#ifndef SCREEN_6010_H
#define SCREEN_6010_H
...
class Screen_6010 : public ::ramp::BindableScreenLogic
{
    public:
    Screen_6010(const std::string&  screen_id)  
    ...
    private:
    	...
    	widget_properties::LabelWidget Label_virtualcontrols_1_0_h_safety_csm{"virtualcontrols_1_0_h_safety_csm"};
