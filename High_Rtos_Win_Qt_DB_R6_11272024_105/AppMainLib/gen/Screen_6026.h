...
class Screen_6026 : public ::ramp::BindableScreenLogic
{
    public:
    Screen_6026(const std::string&  screen_id)  
    ...
    private:
    	...
    	widget_properties::ImageWidget Image_img_control_beams{"img_control_beams"};
    	...
    	widget_properties::LabelWidget Label_virtualcontrols_1_4_0_8_cargo_csm{"virtualcontrols_1_4_0_8_cargo_csm"};
    	widget_properties::LabelWidget Label_virtualcontrols_1_4_cargo_csm{"virtualcontrols_1_4_cargo_csm"};
    ...
    private:
    void Widget_Logic_Visibility_virtualcontrols_1_4_0_8_cargo_csm() noexcept;
    private:
    ...
    private:
    void Widget_Logic_Visibility_img_control_beams() noexcept;
    protected:
