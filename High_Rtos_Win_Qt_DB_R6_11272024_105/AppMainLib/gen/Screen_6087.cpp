...
void Screen_6087::Widget_Logic_Visibility_img_close() noexcept
{
...
void Screen_6087::Widget_Logic_Visibility_img_placeholder_WakeScreen() noexcept
{
    const bool var_007 = gm::csm::VIRTUALCONTROLS_ANDROID_LAUNCH_VISIBILITY.data();
    const bool var_006 = !(var_007);
    
    GroupImage_img_placeholder_WakeScreen.mVisibility = var_006;
}

void Screen_6087::Widget_Logic_Visibility_grp_placeholder_WakeScreen() noexcept
{
    const bool var_009 = gm::csm::VIRTUALCONTROLS_ANDROID_LAUNCH_VISIBILITY.data();
    const bool var_008 = !(var_009);
    
    Group_grp_placeholder_WakeScreen.mVisibility = var_008;
}

void Screen_6087::Widget_Logic_Visibility_virtualcontrols_1_0_4_wakeScreenExit_csm() noexcept
{
...
void Screen_6087::onScreenShow()
{
    mBindingsIds[0U] = Label_virtualcontrols_1_5_0_1_Universal_Remote_csm.mState.bind(gm::csm::Data_RHD_TITLE_ALIGNMENT_STATE);
    addDependency(this, &Screen_6087::Widget_Logic_Visibility_img_close, gm::csm::VIRTUALCONTROLS_ANDROID_LAUNCH_VISIBILITY,gm::csm::VIRTUALCONTROLS_ANDROID_NOIVI_STATE);
    addDependency(this, &Screen_6087::Widget_Logic_Visibility_img_placeholder_WakeScreen, gm::csm::VIRTUALCONTROLS_ANDROID_LAUNCH_VISIBILITY);
    mBindingsIds[1U] = GroupImage_img_placeholder_WakeScreen.mState.bind(gm::csm::VIRTUALCONTROLS_WAKESCREEN_ANDROID_BUTTON_STATE);
    addDependency(this, &Screen_6087::Widget_Logic_Visibility_grp_placeholder_WakeScreen, gm::csm::VIRTUALCONTROLS_ANDROID_LAUNCH_VISIBILITY);
    addDependency(this, &Screen_6087::Widget_Logic_Visibility_virtualcontrols_1_0_4_wakeScreenExit_csm, gm::csm::VIRTUALCONTROLS_ANDROID_LAUNCH_VISIBILITY);
}
