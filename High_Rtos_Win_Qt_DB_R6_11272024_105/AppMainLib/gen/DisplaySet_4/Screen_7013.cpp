...
void Screen_7013::onScreenHide()
{
    ...
    ActivityIndicator_img_progress_activity.Animation.unBind(APA_ACTIVITY_INDICATOR_CONNECTING_APP_PROGRESS, mBindingsIds[1]);
}
...
void Screen_7013::onScreenShow()
{
    ...
    mBindingsIds[1] = ActivityIndicator_img_progress_activity.Animation.bind(APA_ACTIVITY_INDICATOR_CONNECTING_APP_PROGRESS);
