...
void Screen_6021::Widget_Logic_Visibility_virtualcontrols_1_4_0_3_beams_csm()
{
    ...
    Label_virtualcontrols_1_4_0_3_beams_csm.Visibility = var_001;
}
...
void Screen_6021::Widget_Logic_Visibility_img_controls_icn_high_auto_beam()
{
    ...
    Image_img_controls_icn_high_auto_beam.Visibility = var_003;
}
...
void Screen_6021::Widget_Logic_Visibility_virtualcontrols_1_1_exitBtn_csm()
{
    ...
    const auto var_011 = var_013;
    const auto var_012 = var_015;
    const auto var_010 = var_011 && var_012;
    
    Label_virtualcontrols_1_1_exitBtn_csm.Visibility = var_010;
}
...
void Screen_6021::Widget_Logic_Visibility_img_placeholder_WakeScreen()
{
    ...
    const auto var_018 = var_020;
    const auto var_019 = var_022;
...
void Screen_6021::onScreenHide()
{
    ...
    Image_img_radio_button_on.State.unBind(gm::csm::VIRTUALCONTROLS_AUTOHIGHBEAM_STATE_INTERNAL, mBindingsIds[1]);
    ...
    Label_virtualcontrols_1_4_0_3_BeamsOff_csm.State.unBind(gm::csm::VIRTUALCONTROLS_AUTOHIGHBEAM_STATE_INTERNAL, mBindingsIds[3]);
    Label_virtualcontrols_1_4_0_3_BeamsOn_csm.State.unBind(gm::csm::VIRTUALCONTROLS_AUTOHIGHBEAM_STATE_INTERNAL, mBindingsIds[4]);
...
void Screen_6021::onScreenShow()
{
    ...
    mBindingsIds[1] = Image_img_radio_button_on.State.bind(gm::csm::VIRTUALCONTROLS_AUTOHIGHBEAM_STATE_INTERNAL);
    ...
    mBindingsIds[3] = Label_virtualcontrols_1_4_0_3_BeamsOff_csm.State.bind(gm::csm::VIRTUALCONTROLS_AUTOHIGHBEAM_STATE_INTERNAL);
    mBindingsIds[4] = Label_virtualcontrols_1_4_0_3_BeamsOn_csm.State.bind(gm::csm::VIRTUALCONTROLS_AUTOHIGHBEAM_STATE_INTERNAL);
    ...
    addDependency(this, &Screen_6021::Widget_Logic_Visibility_img_placeholder_WakeScreen, gm::csm::VIRTUALCONTROLS_ANDROID_NOIVI_STATE);
