...
void Screen_6008::Widget_Logic_Visibility_img_liftgate()
{
    ...
    Image_img_liftgate.Visibility = var_001;
}
...
void Screen_6008::Widget_Logic_Visibility_virtualcontrols_1_2_0_4_liftgate_csm()
{
    ...
    Label_virtualcontrols_1_2_0_4_liftgate_csm.Visibility = var_003;
}
...
void Screen_6008::onScreenHide()
{
    ...
    Label_virtualcontrols_1_2_0_4_liftgate_custom_csm.State.unBind(gm::csm::VIRTUALCONTROLS_POWERLIFTGATE_STATE_INTERNAL, mBindingsIds[3]);
    ...
    Label_virtualcontrols_1_2_0_4_liftgate_off_csm.State.unBind(gm::csm::VIRTUALCONTROLS_POWERLIFTGATE_STATE_INTERNAL, mBindingsIds[6]);
...
void Screen_6008::onScreenShow()
{
    ...
    mBindingsIds[3] = Label_virtualcontrols_1_2_0_4_liftgate_custom_csm.State.bind(gm::csm::VIRTUALCONTROLS_POWERLIFTGATE_STATE_INTERNAL);
    ...
    mBindingsIds[6] = Label_virtualcontrols_1_2_0_4_liftgate_off_csm.State.bind(gm::csm::VIRTUALCONTROLS_POWERLIFTGATE_STATE_INTERNAL);
    ...
    addDependency(this, &Screen_6008::Widget_Logic_Visibility_img_placeholder_WakeScreen, gm::csm::VIRTUALCONTROLS_ANDROID_NOIVI_STATE);
