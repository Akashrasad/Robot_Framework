...
void Screen_6006::Widget_Logic_Visibility_virtualcontrols_1_2_0_2_lockout_csm()
{
    ...
    Label_virtualcontrols_1_2_0_2_lockout_csm.Visibility = var_001;
}
...
void Screen_6006::Widget_Logic_Visibility_img_control_lockout()
{
    ...
    Image_img_control_lockout.Visibility = var_015;
}
...
void Screen_6006::Widget_Logic_Visibility_virtualcontrols_1_1_exitBtn_csm()
{
    ...
    Label_virtualcontrols_1_1_exitBtn_csm.Visibility = var_017;
}

void Screen_6006::onScreenHide()
{
    Label_virtualcontrols_1_2_0_2_LockoutOff_csm.State.unBind(gm::csm::VIRTUALCONTROLS_POWERWINDOWLOCKOUT_STATE_INTERNAL, mBindingsIds[0]);
    Image_img_radio_button_off.State.unBind(gm::csm::VIRTUALCONTROLS_POWERWINDOWLOCKOUT_STATE_INTERNAL, mBindingsIds[1]);
    ...
    Image_img_radio_button_on.State.unBind(gm::csm::VIRTUALCONTROLS_POWERWINDOWLOCKOUT_STATE_INTERNAL, mBindingsIds[4]);
}

void Screen_6006::onScreenShow()
{
    mBindingsIds[0] = Label_virtualcontrols_1_2_0_2_LockoutOff_csm.State.bind(gm::csm::VIRTUALCONTROLS_POWERWINDOWLOCKOUT_STATE_INTERNAL);
    ...
    mBindingsIds[1] = Image_img_radio_button_off.State.bind(gm::csm::VIRTUALCONTROLS_POWERWINDOWLOCKOUT_STATE_INTERNAL);
    ...
    addDependency(this, &Screen_6006::Widget_Logic_Visibility_img_placeholder_WakeScreen, gm::csm::VIRTUALCONTROLS_ANDROID_NOIVI_STATE);
    ...
    mBindingsIds[4] = Image_img_radio_button_on.State.bind(gm::csm::VIRTUALCONTROLS_POWERWINDOWLOCKOUT_STATE_INTERNAL);
}
