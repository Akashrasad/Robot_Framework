...
void Screen_7001::onScreenHide()
{
    ...
    Label_apa_3_0_WhatTypePark_csm.State.unBind(gm::csm::APA_PARK_INSTRUCTIONS_INTERNAL, mBindingsIds[9]);
    Label_apa_dyn_3_0_ToExitDrawer_csm.State.unBind(APA_EXIT_PARK_DRAWER_REQUEST, mBindingsIds[10]);
    Image_img_park_left_perp.State.unBind(gm::csm::APA_PARK_INSTRUCTIONS_INTERNAL, mBindingsIds[11]);
}
...
void Screen_7001::onScreenShow()
{
    ...
    mBindingsIds[9] = Label_apa_3_0_WhatTypePark_csm.State.bind(gm::csm::APA_PARK_INSTRUCTIONS_INTERNAL);
    mBindingsIds[10] = Label_apa_dyn_3_0_ToExitDrawer_csm.State.bind(APA_EXIT_PARK_DRAWER_REQUEST);
    mBindingsIds[11] = Image_img_park_left_perp.State.bind(gm::csm::APA_PARK_INSTRUCTIONS_INTERNAL);
}
