...
class Screen_6024 : public ::ramp::BindableScreenLogic
{
    public:
    Screen_6024(const std::string&  screen_id)  
    ...
    private:
    	...
    	widget_properties::ImageWidget Image_img_controls_icn_fog_rear{"img_controls_icn_fog_rear"};
    	...
    	widget_properties::LabelWidget Label_virtualcontrols_1_4_0_6_FogRearOff_csm{"virtualcontrols_1_4_0_6_FogRearOff_csm"};
    	widget_properties::LabelWidget Label_virtualcontrols_1_4_0_6_FogRearOn_csm{"virtualcontrols_1_4_0_6_FogRearOn_csm"};
    	widget_properties::LabelWidget Label_virtualcontrols_1_4_0_6_fog_csm{"virtualcontrols_1_4_0_6_fog_csm"};
    	widget_properties::LabelWidget Label_virtualcontrols_1_4_fogRear_csm{"virtualcontrols_1_4_fogRear_csm"};
    ...
    private:
    void Widget_Logic_Visibility_img_controls_icn_fog_rear() noexcept;
    private:
