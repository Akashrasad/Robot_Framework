...
void Screen_8010::onScreenHide()
{
    ...
    Image_img_exit_btn_mfc_camera.mVisibility.unBind(gm::csm::Data_Close_Button_Visibility, mBindingsIds[2U]);
...
void Screen_8010::onScreenShow()
{
    ...
    mBindingsIds[2U] = Image_img_exit_btn_mfc_camera.mVisibility.bind(gm::csm::Data_Close_Button_Visibility);
