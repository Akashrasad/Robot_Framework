...
void Screen_7009::onScreenHide()
{
    ...
    GroupImage_img_yes_btn.State.unBind(gm::csm::Data_APA_SELECTION_YES_BUTTON_STATE, mBindingsIds[4]);
...
void Screen_7009::onScreenShow()
{
    ...
    mBindingsIds[4] = GroupImage_img_yes_btn.State.bind(gm::csm::Data_APA_SELECTION_YES_BUTTON_STATE);
