...
void Screen_7001::onScreenHide()
{
    ...
    Label_apa_3_0_ParaRight_csm.State.unBind(gm::csm::APA_PARK_INSTRUCTIONS_INTERNAL, mBindingsIds[5]);
    Label_apa_3_0_PerpLeft_csm.State.unBind(gm::csm::APA_PARK_INSTRUCTIONS_INTERNAL, mBindingsIds[6]);
    Label_apa_3_0_ParaLeft_csm.State.unBind(gm::csm::APA_PARK_INSTRUCTIONS_INTERNAL, mBindingsIds[7]);
    Label_apa_3_0_WhatTypePark_csm.State.unBind(gm::csm::APA_PARK_INSTRUCTIONS_INTERNAL, mBindingsIds[8]);
...
void Screen_7001::onScreenShow()
{
    ...
    mBindingsIds[5] = Label_apa_3_0_ParaRight_csm.State.bind(gm::csm::APA_PARK_INSTRUCTIONS_INTERNAL);
    mBindingsIds[6] = Label_apa_3_0_PerpLeft_csm.State.bind(gm::csm::APA_PARK_INSTRUCTIONS_INTERNAL);
    mBindingsIds[7] = Label_apa_3_0_ParaLeft_csm.State.bind(gm::csm::APA_PARK_INSTRUCTIONS_INTERNAL);
    mBindingsIds[8] = Label_apa_3_0_WhatTypePark_csm.State.bind(gm::csm::APA_PARK_INSTRUCTIONS_INTERNAL);
