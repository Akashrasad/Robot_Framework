...
constexpr static const char_t* const Hash_ics_virtualcontrols_lights_auto_high_beams_unavailable_snackbar = ramp::Hash(ics_virtualcontrols_lights_auto_high_beams_unavailable_snackbar);
