...
constexpr static const char_t* const ics_virtualcontrols_lights_auto_high_beams_unavailable_snackbar = "ics_virtualcontrols_lights_auto_high_beams_unavailable_snackbar";
...
{
    {
        ...
        ics_virtualcontrols_lights_auto_high_beams_unavailable_snackbar,
