...
void Screen_7029::onScreenHide()
{
    ...
    Group_grp_keep_looking_btn.Visibility.unBind(gm::csm::Data_APA_SPOT_SELENT_KEEP_LKNG_BUTTON_VISIBILITY, mBindingsIds[5]);
...
void Screen_7029::onScreenShow()
{
    ...
    mBindingsIds[5] = Group_grp_keep_looking_btn.Visibility.bind(gm::csm::Data_APA_SPOT_SELENT_KEEP_LKNG_BUTTON_VISIBILITY);
