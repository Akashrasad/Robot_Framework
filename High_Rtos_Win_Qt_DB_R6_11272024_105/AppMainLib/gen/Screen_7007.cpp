...
void Screen_7007::onScreenHide()
{
    ...
    GroupLabel_apa_4_4_ParkInVehicle_csm.mState.unBind(gm::csm::Data_APA_SELECTION_YES_BUTTON_STATE, mBindingsIds[2U]);
    ...
    Group_grp_park_in_vehicle_btn.mVisibility.unBind(gm::csm::Data_APA_SPOT_SELENT_YES_BUTTON_VISIBILITY, mBindingsIds[5U]);
    Image_img_apa_exit_btn.mVisibility.unBind(gm::csm::EXIT_BUTTON_AVAILABLE_IN_APA, mBindingsIds[6U]);
    Group_grp_keep_looking_btn.mVisibility.unBind(gm::csm::Data_APA_SPOT_SELENT_KEEP_LKNG_BUTTON_VISIBILITY, mBindingsIds[7U]);
    GroupLabel_apa_4_4_KeepLooking_csm.mState.unBind(gm::csm::Data_APA_SELECTION_KEEP_LOOKING_BUTTON_STATE, mBindingsIds[8U]);
}

void Screen_7007::onScreenShow()
{
    ...
    mBindingsIds[2U] = GroupLabel_apa_4_4_ParkInVehicle_csm.mState.bind(gm::csm::Data_APA_SELECTION_YES_BUTTON_STATE);
    ...
    mBindingsIds[5U] = Group_grp_park_in_vehicle_btn.mVisibility.bind(gm::csm::Data_APA_SPOT_SELENT_YES_BUTTON_VISIBILITY);
    mBindingsIds[6U] = Image_img_apa_exit_btn.mVisibility.bind(gm::csm::EXIT_BUTTON_AVAILABLE_IN_APA);
    mBindingsIds[7U] = Group_grp_keep_looking_btn.mVisibility.bind(gm::csm::Data_APA_SPOT_SELENT_KEEP_LKNG_BUTTON_VISIBILITY);
    mBindingsIds[8U] = GroupLabel_apa_4_4_KeepLooking_csm.mState.bind(gm::csm::Data_APA_SELECTION_KEEP_LOOKING_BUTTON_STATE);
}
